...
//ödev 1
// const trkn = "tarkan";
// console.log(trkn.length);
const tarkan1 = "Gel gunduzle gece olalim";
const klm = tarkan1.split(" ");
console.log(klm.length);

//ödev2
http1 = "https://www.youtube.com/watch?v=b7vfp5G4brE";
console.log(http1.lastIndexOf("="));
console.log(http1.length);
console.log(http1.lastIndexOf("=") - http1.length);
console.log(
  http1.slice(http1.lastIndexOf("=") + 1 - http1.length, http1.length)
);
let final = http1.slice(
  http1.lastIndexOf("=") + 1 - http1.length,
  http1.length
);
console.log("https://youtu.be/" + `${final}`);
